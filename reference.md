...
3. Cross-time regression analysis is a first-class use case: a comparison lens consumes N archived JSON files and emits a regression HTML, with no re-observation needed. See rfc.md §11 for a worked example.
